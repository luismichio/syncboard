              ...
              {selectedItems.length > 0 ? (
                <div className="space-y-3">
                  ...
                  {getGroupedItems().length > 3 && (
                    <div className="flex items-start gap-2 p-2.5 mt-2 rounded-md bg-amber-600/20 border border-amber-400/60">
                      ...
                      <span className="text-xs text-amber-200 font-semibold font-mono leading-snug">
