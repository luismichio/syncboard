...
describe('parsePenpotUrl', () => {
  ...
  it('should return null for URLs lacking node/objectId', () => {
    const url = 'https://design.penpot.app/#/workspace/a875/project/123/file/0c9a099a-7a56-8049-8002-c9a72cd16e45';
    const result = parsePenpotUrl(url);
    expect(result).toBeNull();
  });
